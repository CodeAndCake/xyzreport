...
Bombs dropped in Israeli air strikes fall on the al-Tannur neighbourhood of Rafah on the morning of 1 August 2014. © Said Khatib/AFP/Getty Images.
    ...
    <!-- Hannibal Section -->
    <!-- Hannibal Section -->
    <!-- Page --><section id="summary-2" class="top-section summary-2 section"><div class="container" style="padding-top:0;"><div class="row"><div class="col-lg-10">
<div class="box">
<h2><span class="h2-heading">executive summary</span></h2>
</div>
<p>
...
<div class="img-box fit">
    <a href="assets/heatmap.jpg" data-lightbox="lightbox70" data-title="A Pléiades satellite image of eastern Rafah, taken on 14 August 2014 at 11.50am, is marked with air strike craters (large red dots) and artillery craters (small red dots) and the resulting intensity of attacks (shades of red). © CNES 2014, Distribution AIRBUS DS, all rights reserved.">
        <img src="assets/heatmap.jpg" class="img-responsive img-thumbnail">
    </a>
</div>
<span class="caption">
...
“In such an event you prefer a killed soldier rather than a soldier in enemy hands, like [Gilad] Shalit. I told myself ‘even if I bring back a corpse I have brought back the missing person’.” 
</p>
<p>
...
<div class="img-box fit">
    <a href="assets/tannur.jpg" data-lightbox="lightbox72" data-title="A collage of photographs shows the aftermath of the Israeli air strike on al-Tannur, in Rafah. © Al Mezan Center for Human Rights.">
        <img src="assets/tannur.jpg" class="img-responsive img-thumbnail">
    </a>
</div>
<span class="caption">
